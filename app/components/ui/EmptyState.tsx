...
const ICONS: Record<NonNullable<EmptyStateProps["icon"]>, React.ReactNode> = {
  members:    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm13 10v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/>,
  sermons:    <><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></>,
  ...
  devotion:   <><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></>,
...
export function EmptyState({ title, message, action, icon = "generic" }: EmptyStateProps) {
  return (
    <div
    ...
    >
      ...
      <p className="text-sm font-sans text-gray-500 max-w-sm leading-relaxed mb-6">
        {message}
      </p>
      {action && (
        <a
          href={action.to}
          className="px-5 py-2.5 bg-red-700 text-white text-sm font-sans
